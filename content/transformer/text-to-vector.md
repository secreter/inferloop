...
![one-hot 编码示意](/books/transformer/text-to-vector/one-hot-vocabulary-example.png)
...
![词表与 Token ID 映射](/books/transformer/text-to-vector/vocabulary.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![Embedding lookup 示意](/books/transformer/text-to-vector/embeddings.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
