...
![Transformer 整体架构](/books/transformer/transformer-architecture/the_transformer_3.png)
...
![Encoder-Decoder 整体示意](/books/transformer/transformer-architecture/The_transformer_encoders_decoders.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*

![Encoder 和 Decoder 堆叠结构](/books/transformer/transformer-architecture/The_transformer_encoder_decoder_stack.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![位置编码向量示意](/books/transformer/transformer-architecture/transformer_positional_encoding_vectors.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![位置编码示例（小尺度）](/books/transformer/transformer-architecture/transformer_positional_encoding_example.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*

![位置编码示例（大尺度热力图）](/books/transformer/transformer-architecture/transformer_positional_encoding_large_example.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![Encoder Block 内部结构](/books/transformer/transformer-architecture/Transformer_encoder.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![残差连接与 Layer Norm（单层）](/books/transformer/transformer-architecture/transformer_resideual_layer_norm.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*

![残差连接与 Layer Norm（Encoder 视角）](/books/transformer/transformer-architecture/transformer_resideual_layer_norm_2.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*

![残差连接与 Layer Norm（完整 Encoder-Decoder）](/books/transformer/transformer-architecture/transformer_resideual_layer_norm_3.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![Decoder Block 内部结构](/books/transformer/transformer-architecture/Transformer_decoder.png)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
...
![自回归解码过程（动图第一帧）](/books/transformer/transformer-architecture/transformer_decoding_1.gif)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*

![自回归解码过程（动图第二帧）](/books/transformer/transformer-architecture/transformer_decoding_2.gif)
*图片来源：[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) by Jay Alammar*
