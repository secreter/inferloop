...
export const BOOKS: Book[] = [
  {
    ...
    subtitle: '从 Claude Code 开源架构到你的第一个编程助手',
    desc: '以 Ling 为主线，从零构建一个 AI 编程助手，覆盖 Agent 运行时、工具系统、MCP 协议、多 Agent 协作等核心主题。',
    cover: 'https://images.redream.cn/images/MpSMEl.png',
    chapters: 14,
    status: 'in-progress',
  },
  {
    ...
    subtitle: '用 TypeScript 构建现代 CLI 工具',
    desc: '以 repox 这个 AI 驱动的仓库助手为案例，系统讲解命令设计、插件系统、AI 集成、GitHub OAuth、发布与分发等完整工程链路。',
    cover: 'https://images.redream.cn/images/p5EEQm.png',
    chapters: 14,
    status: 'in-progress',
  },
  {
  ...
  },
  {
    ...
    subtitle: '从 claude-mem 源码到企业级记忆平台',
    desc: '深入解析 Agent 记忆系统的工程实现：Hook 生命周期、Worker 服务、MCP Search、渐进式披露机制，以及从单机到企业级的演进路径。',
    cover: 'https://images.redream.cn/images/Om4nBq.png',
    chapters: 19,
    status: 'in-progress',
  },
  {
    ...
    cover: 'https://images.redream.cn/images/k6Sky9.png',
    chapters: null,
    status: 'planning',
  },
  {
    ...
    cover: 'https://images.redream.cn/images/XwX564.png',
    chapters: null,
    status: 'planning',
  },
];
